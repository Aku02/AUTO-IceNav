"""Dynamic Positioning (DP) demo with diffusion planner"""
import pickle
...
CFG.diffusion = {
    ...
    'beta0': 1e-4,          # Initial beta
    'betaT': 1e-2           # Final beta
}
...
# CFG.output_dir = None      # option to store trial data to disk
# CFG.planner = 'diffusion'  # Use diffusion planner
# CFG.plot.show = False      # option to enable planner plotting
# CFG.optim = False
# CFG.max_replan = 1         # comment out to have no limit on replans
# CFG.horizon = 70
...
def main():
    ...
    try:
        ...
        print('Done DP demo with diffusion planner! steps', steps)
...
if __name__ == '__main__':
    print('Launching dynamic positioning demo with diffusion planner...')
    main()

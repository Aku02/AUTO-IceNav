...
def main():
    ...
    parser.add_argument('--input', type=str, default='MEDEA_fram_20100629.png',
                        help='Input segmented image path')
    parser.add_argument('--output', type=str, default='ice_floes_MEDEA_fram_20100629.pkl',
    ...
    parser.add_argument('--epsilon_factor', type=float, default=0.001,
    ...
    for color in unique_colors:
        ...
        for contour in contours:
            ...
            # Optional: smooth contour slightly while keeping detail
            # epsilon controls approximation accuracy (smaller = more detailed)
            epsilon = args.epsilon_factor * cv2.arcLength(contour, True)  # very small epsilon for detail
            approx = cv2.approxPolyDP(contour, epsilon, True)
            ice_flow_vertices = approx[:, 0, :]
